...
<body class="lightBG lightColor">
    <div id="header">
        ...
        <div id="right-elements" style="position:relative">
            <div>
                @foreach (Config::get('languages') as $lang => $language)
                    @if ($lang != App::getLocale())
                        <a href="{{ route('lang.switch', $lang) }}"
                            style="text-decoration:none; font-weight:bold">{{ $language }}</a>
                    @endif
                @endforeach
            </div>
            ...
            <div id="nav" class="light-bg-nav">
                <span style="font-size: 2.5em; position:absolute; right:1px;top:-32px; color:#f3f2f9;">▲</span>
